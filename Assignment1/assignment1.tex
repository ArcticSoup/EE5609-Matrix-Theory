...
\begin{abstract}
This document contains the solution to find the angle between two lines.
\end{abstract}
Download all python codes from 
%
\begin{lstlisting}
https://github.com/ArcticSoup/EE5609-Matrix-Theory/tree/master/Codes
\end{lstlisting}
%
and latex-tikz codes from 
%
\begin{lstlisting}
https://github.com/ArcticSoup/EE5609-Matrix-Theory/tree/master/Assignment1
\end{lstlisting}
%
\section{Problem}
...
\section{Solution}
\begin{flushleft}
Consider the equation of the lines to be 
\begin{center}
 $$\frac{x + 3}{3}=\frac{y-1}{5}=\frac{z+3}{4}=\lambda_1$$
 $$\frac{x + 1}{1}=\frac{y-4}{1}=\frac{z-5}{2}=\lambda_2$$
 \end{center}
 Using these equations, the matrix form of the lines can be expressed as
 \begin{center}
 $$
 \begin{pmatrix}
 x\\
 ...
 Which gives us,
 \begin{equation*}
 \vec{a}\cdot\vec{b} = \vec{a}^T\vec{b} = 16
 \end{equation*}
 \begin{equation*}
 \norm{\textbf{a}} = \sqrt{50},  
 \norm{\textbf{b}} = \sqrt{6}
